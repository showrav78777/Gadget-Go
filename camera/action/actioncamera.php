...
$sql = "SELECT * FROM products WHERE category = 'Camera' AND brand = 'action'";
...
<head>
    ...
    <title>Action Camera Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Action Camera Price in Bangladesh</h1>
        <p class="text-center">
            Action Camera Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
            <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Action Camera from Gadget & Gear shop.
            ...
            <div class="col-md-9">
                ...
                <div class="product-container">
                    <?php if (!empty($products)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p>No Action Camera products found.</p>
                    <?php endif; ?>
