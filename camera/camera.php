...
<head>
    ...
    <title>Camera Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Camera Price in Bangladesh</h1>
        <p class="text-center">
            Camera Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
            <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Camera from Gadget & Gear shop.
