...
$sql = "SELECT * FROM products WHERE category = 'Camera' AND brand = 'dslr'";
...
<head>
    ...
    <title>DSLR Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">DSLR Price in Bangladesh</h1>
        <p class="text-center">
            DSLR Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest DSLR from Gadget & Gear shop. 
