...
$sql = "SELECT * FROM products WHERE category = 'PC'";
...
<head>
    ...
    <title>PC Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">PC Price in Bangladesh</h1>
        <p class="text-center">
            PC Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
            <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest PC from Gadget & Gear shop.
