...
$sql = "SELECT * FROM products WHERE category = 'PC' AND brand  = 'monitor'";
...
<head>
    ...
    <title>Monitors Price in Bangladesh</title>
...
<body>
  ...
  <div class="top-navbar">
    ...
    <div class="container mt-4">
        <h1 class="text-center">Monitors Price in Bangladesh</h1>
        <p class="text-center">
            Monitors Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Monitors from Gadget & Gear shop. 
