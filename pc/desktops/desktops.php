...
$sql = "SELECT * FROM products WHERE category = 'PC' AND brand  = 'desktop'";
...
<head>
    ...
    <title>Desktops Price in Bangladesh</title>
...
<body>
  ...
  <div class="top-navbar">
    ...
    <div class="container mt-4">
        <h1 class="text-center">Desktops Price in Bangladesh</h1>
        <p class="text-center">
            Desktops Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Desktop PCs from Gadget & Gear shop. 
