...
$sql = "SELECT * FROM products WHERE category = 'PC' AND brand  = 'laptop'";
...
<head>
    ...
    <title>Laptops Price in Bangladesh</title>
...
<body>
  ...
  <div class="top-navbar">
    ...
    <div class="container mt-4">
        <h1 class="text-center">Laptops Price in Bangladesh</h1>
        <p class="text-center">
            Laptops Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Laptops from Gadget & Gear shop. 
