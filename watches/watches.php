...
<head>
    ...
    <title>Watches Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Watches Price in Bangladesh</h1>
        <p class="text-center">
            Watches Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
            <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Watches from Gadget & Gear shop.
