...
$sql = "SELECT * FROM products WHERE category = 'Watches' AND brand = 'fitness_tracker'";
...
<head>
    ...
    <title>Fitness Tracker Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Fitness Trackers Price in Bangladesh</h1>
        <p class="text-center">
            Fitness Trackers Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Fitness Trackers from Gadget & Gear shop. 
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-between mb-3">
                    <h4>Available Fitness Trackers</h4>
                ...
                <div class="product-container">
                    <?php if (!empty($products)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p>No Fitness Tracker products found.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
