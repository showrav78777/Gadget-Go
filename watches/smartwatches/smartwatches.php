...
$sql = "SELECT * FROM products WHERE category = 'Watches' and brand= 'smartwatch";
...
<head>
    ...
    <title>Smart Watches Price in Bangladesh</title>
...
<body>
 ...
 <div class="top-navbar">
    ...
    <div class="container mt-4">
        <h1 class="text-center">Smart Watches Price in Bangladesh</h1>
        <p class="text-center">
            Smart Watches Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Smart Watches from Gadget & Gear shop. 
            ...
            <div class="col-md-9">
                ...
                <div class="product-container">
                    <?php if (!empty($products)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p>No Smart Watch products found.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
