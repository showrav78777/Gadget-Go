...
$sql = "SELECT * FROM products WHERE category = 'Gadgets' AND brand = 'Wearable Tech'";
...
<head>
    ...
    <title>Wearable Tech Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Wearable Tech Price in Bangladesh</h1>
        <p class="text-center">
            Wearable Tech Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Wearable Tech from Gadget & Gear shop. 
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="filter-section">
                    <h4>Price Range</h4>
                    <input type="range" id="priceRange" class="form-range" min="<?php echo $minPrice; ?>" max="<?php echo $maxPrice; ?>" value="<?php echo $maxPrice; ?>">
                    ...
                    <?php if (!empty($products)): ?>
                        <?php foreach ($products as $product): ?>
                            ...
                            <a href="http://localhost/g&g/home/product_details.php?id=<?php echo $product['product_id']; ?>">
                                <img src="../../admin/admin_product/<?php echo $product['image_url']; ?>" alt="<?php echo $product['brand'] . ' ' . $product['model']; ?>">
                            </a>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p>No Wearable Tech products found.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
