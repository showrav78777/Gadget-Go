...
<head>
    ...
    <title>Gadgets Price in Bangladesh</title>
...
<body>
  ...
  <div class="top-navbar">
    ...
    <div class="container mt-4">
        <h1 class="text-center">Gadgets Price in Bangladesh</h1>
        <p class="text-center">
            Gadgets Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
