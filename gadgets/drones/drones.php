...
$sql = "SELECT * FROM products WHERE category = 'Gadgets' AND brand = 'Drones'";
...
<head>
    ...
    <title>Drones Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Drones Price in Bangladesh</h1>
        <p class="text-center">
            Drones Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Drones from Gadget & Gear shop. 
