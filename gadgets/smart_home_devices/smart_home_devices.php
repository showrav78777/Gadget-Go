...
$sql = "SELECT * FROM products WHERE category = 'Gadgets' AND brand = 'Smart Home Devices'";
...
<head>
    ...
    <title>Smart Home Devices Price in Bangladesh</title>
...
<body>
  ...
  <div class="top-navbar">
    ...
    <div class="container mt-4">
        <h1 class="text-center">Smart Home Devices Price in Bangladesh</h1>
        <p class="text-center">
            Smart Home Devices Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
            <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Smart Home Devices from Gadget & Gear shop.
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-between mb-3">
                    <h4>Available Smart Home Devices</h4>
                ...
                <div class="product-container">
                    <?php if (!empty($products)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p>No Smart Home Devices products found.</p>
                    <?php endif; ?>
