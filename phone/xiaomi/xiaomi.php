...
$sql = "SELECT * FROM products WHERE category = 'Smartphones' AND brand = 'xiaomi'";
...
<head>
    ...
    <title>Xiaomi Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Xiaomi Price in Bangladesh</h1>
        <p class="text-center">
            Xiaomi Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
            <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Xiaomi from Gadget & Gear shop.
                    ...
                    <?php if (!empty($products)): ?>
                        <?php foreach ($products as $product): ?>
                            <div class="product-card" data-price="<?php echo $product['price']; ?>">
                                <a
                                    href="http://localhost/g&g/home/product_details.php?id=<?php echo $product['product_id']; ?>">
                                    ...
                                    <?php if ($product['stock'] > 0): ?>
                                        ...
                                        <div class="buttons">
                                            ...
                                            <button class="add-to-cart"
                                                onclick="addToCart(<?php echo $product['product_id']; ?>)">Add
                                                to Cart</button>
                                        </div>
                                    <?php else: ?>
