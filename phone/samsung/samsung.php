...
$sql = "SELECT * FROM products WHERE category = 'Smartphones' AND brand = 'Samsung'";
...
<head>
    ...
    <title>Samsung Price in Bangladesh</title>
...
<body>
  ...
  <div class="top-navbar">
    ...
    <div class="container mt-4">
        <h1 class="text-center">Samsung Price in Bangladesh</h1>
        <p class="text-center">
            Samsung Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Samsung Galaxy from Gadget & Gear shop. 
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-between mb-3">
                    <h4>Available Samsung Products</h4>
