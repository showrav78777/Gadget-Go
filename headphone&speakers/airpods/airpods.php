...
$sql = "SELECT * FROM products WHERE category = 'Headphone & Speaker' AND brand= 'Airpods'";
...
<head>
    ...
    <title>Airpods Price in Bangladesh</title>
...
<body>
   ...
   <div class="top-navbar">
    ...
    <div class="container mt-4">
        <h1 class="text-center">Airpods Price in Bangladesh</h1>
        <p class="text-center">
            Airpods Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
            <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Airpods from Gadget & Gear shop.
