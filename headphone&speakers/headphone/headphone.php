...
$sql = "SELECT * FROM products WHERE category = 'Headphone & Speaker' AND brand = 'Headphone'";
...
<head>
    ...
    <title>Headphone Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Headphone Price in Bangladesh</h1>
        <p class="text-center">
            Headphone Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
            <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Headphone from Gadget & Gear shop.
