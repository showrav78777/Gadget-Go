...
$sql = "SELECT * FROM products WHERE category = 'Headphone & Speaker' AND brand = 'Neckband'";
...
<head>
    ...
    <title>Neckband Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Neckband Price in Bangladesh</h1>
        <p class="text-center">
            Neckband Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
            <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Neckband from Gadget & Gear shop.
            ...
            <div class="col-md-9">
                ...
                <div class="product-container">
                    <?php if (!empty($products)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p>No Neckband products found.</p>
                    <?php endif; ?>
