...
$sql = "SELECT * FROM products WHERE category = 'Headphone & Speaker' AND brand = 'Speaker'";
...
<head>
    ...
    <title>Speaker Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Speaker Price in Bangladesh</h1>
        <p class="text-center">
            Speaker Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
            <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Speaker from Gadget & Gear shop.
