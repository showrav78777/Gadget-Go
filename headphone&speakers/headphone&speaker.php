...
$sql = "SELECT * FROM products WHERE category = 'Headphone & Speaker'";
...
<head>
    ...
    <title>Headphone & Speaker Price in Bangladesh</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Headphone & Speaker Price in Bangladesh</h1>
        <p class="text-center">
            Headphone & Speaker Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
            <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Headphone & Speaker from Gadget & Gear shop.
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-between mb-3">
                    <h4>Available Headphone & Speaker</h4>
                ...
                <div class="product-container">
                    <?php if (!empty($products)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p>No Headphone & Speaker products found.</p>
                    <?php endif; ?>
