...
$sql = "SELECT * FROM products WHERE category = 'Phone Accecories' AND subcategory = 'Phone Charger'";
...
<head>
    ...
    <title>Phone Charger Price in Bangladesh</title>
...
<body>
  ...
  <div class="top-navbar">
    ...
    <div class="container mt-4">
        <h1 class="text-center">Phone Charger Price in Bangladesh</h1>
        <p class="text-center">
            Phone Charger Price & Deal starts from BDT <?php echo number_format($minPrice); ?> to BDT
            <?php echo number_format($maxPrice); ?> in Bangladesh. Buy the latest Phone Charger from Gadget & Gear shop.
            ...
            <div class="col-md-9">
                ...
                <div class="product-container">
                    <?php if (!empty($products)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p>No Phone Charger products found.</p>
                    <?php endif; ?>
